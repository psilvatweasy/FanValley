...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    [LogManager Log_Quick:@"Last Y - %f", self.lastOffsetY];
    [LogManager Log_Quick:@"Current Y - %f", scrollView.contentOffset.y];
    [LogManager Log_Quick:@"result - %f", self.lastOffsetY - scrollView.contentOffset.y];
    

    float result = self.lastOffsetY - scrollView.contentOffset.y;
    [LogManager Log_Quick:@"AA - %f", self.sponsorView.frame.origin.y];
    [LogManager Log_Quick:@"BB - %f", self.view.frame.size.height];
...
//    [UIView commitAnimations];
    ...
    [self.navigationController pushViewController:[[FVFanCardViewController alloc] init] animated:YES];
}
@end
